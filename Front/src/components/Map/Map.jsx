...
export const Map = ({ selectedLatLng }) => {
    ...
    useEffect(() => {
        if (selectedLatLng && mapRef.current) {
            ...
            const bounds = L.latLngBounds({},[selectedLatLng.lat, selectedLatLng.lng]);
        ...
        // }))
        setCenterMap(setCenterMap(prevCenterMap => ({
            lat: selectedLatLng.lat,
            lng: selectedLatLng.lng,
        })))
  ...
  return (
    <div className="flex items-center justify-center">
        <MapContainer ref={mapRef} center={centerMap || [-31.42008329999999, -64.1887761]} zoom={5}>
        <TileLayer
